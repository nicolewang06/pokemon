      ...
      <h2 id="aboutTitle">About My Pok&#233;mon API React App</h2><br></br><br></br>
        ...
        <div id="aboutPlayContainer">
          ...
          <div id="aboutPlayContent">
            <ul>
            <li>The wordsearch game is currently static</li>
            </ul>
          </div>
        </div>
            ...
            <div className="pokemonCardContainer">
              ...
              <div className="pokemonCard">           
                  ...
                  <div className="pokemonBackground"  key={this.state.data.id}>
                    <a href="pokedex"><img id="pokemonImage" src= {img + this.state.data.id + ".png"} alt="" width="150px" /></a>
                  </div> 
...
class Play extends React.Component{
  ...
  async componentDidMount() {
    try{
      const res = await axios.get("https://pokeapi.co/api/v2/pokemon?limit=151");
      this.setState({ thePokemon: res.data.results })
      console.log(res)
    } catch(err) {
...
render() {
  return(
    <div id="playContainer">
      <div id="playContent">
          <p>let's play who's that pokemon</p>
       </div>
    </div>
