    ...
    render() {
      ...
      <Router>
        <div className="header">
          <div className="nav">
            <Link to="/home">Home</Link>&nbsp; || &nbsp;<Link to="/Pokedex">Pok&#233;dex</Link>&nbsp; || &nbsp;<Link to="/pokemon">Pok&#233;mon</Link>
          </div>
            ...
            <div className="pokemonCardContainer">
              ...
              <div className="pokemonCard">           
                  ...
                  <div className="pokemonBackground"  key={this.state.data.id}>
                    <a href="pokedex"><img id="pokemonImage" src= {img + this.state.data.id + ".png"} alt="" width="100px" /></a>
                  </div> 
          ...
          <div className = "pokedexSearchBar">
            <form 
                ...
                onClick={this.handleSubmit}>
                  <input type="text" name="search" id="search" placeholder="enter Pok&#233;mon name or # between 1 - 898" size="42" />
                  &nbsp;&nbsp;<input type="submit" id="pokedexSearch" value="who's that Pok&#233;mon ?"  />
            </form> 
          </div>
             ...
             {/* ------ left side of pokedex -------- */}
              ...
              <div className="imgContainer">
                ...
                <div className="imgDisplay">
                  <img src= {sprite + this.state.data.id + ".png"} alt=""  />
                </div>
                ...
                <div id="detailsBox"><p id="pokedexName">{this.state.data.name}</p></div>
                  <div className="blueButtonContainer">
                    ...
                    <div className="pokedexBottomRight">
                      <div id="leftBottom">Height: {this.state.data.height}</div>
                      <div id="rightBottom">Weight: {this.state.data.weight}</div>
                    </div>
